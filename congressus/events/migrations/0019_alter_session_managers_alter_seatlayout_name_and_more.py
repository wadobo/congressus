# Generated by Django 4.2.5 on 2023-11-23 10:15
...
def remove_seat_layout_spaces(apps, schema_editor):
    SeatLayout = apps.get_model("events", "SeatLayout")
    seat_layouts_with_space_in_name = SeatLayout.objects.filter(name__contains=" ")
    for seat_layout in seat_layouts_with_space_in_name:
        seat_layout.name = seat_layout.name.replace(" ", "_")
        seat_layout.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(remove_seat_layout_spaces),
        ...
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(max_length=300, validators=[events.validators.not_contains_spaces], verbose_name='name'),
        ),
        migrations.AlterField(
