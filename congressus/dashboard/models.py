...
class ConfigChart(models.Model):
    ...
    timestep = models.CharField(
        _("time step"), max_length=10, choices=TIMESTEPS, default="daily"
    )
...
class Dashboard(models.Model):
    ...
    num_cols = models.CharField(
        _("number columns"), max_length=2, choices=NUM_COLS, default="2"
    )
